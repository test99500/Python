...
importation = pd.DataFrame(columns=["Keelung customs", "Taipei customs", "Taichung customs", "Kaohsiung customs", "Total"],
...
exportation = pd.DataFrame(data=[[1544095246, 5561724423, 2550413664, 3030786960, 12687020293],
                           ...
                           columns=["Keelung customs", "Taipei customs", "Taichung customs", "Kaohsiung customs", "Total"],
