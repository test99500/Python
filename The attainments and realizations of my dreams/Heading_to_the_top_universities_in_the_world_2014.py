...
university = pd.DataFrame(data=[
    ...
    [2, "國立成功大學", "National Cheng Kung University", 155000, "South", ],
    [3, "國立清華大學", "National Tsing Hua University", 123000, "North", "Derived from Beijing, China's Tsing Hua University"],
    [4, "國立交通大學", "National Chiao Tung University", 103000, "North", "Derived from Shanghai, China's ChiaoTung University"],
    [5, "國立中央大學", "National Central University", 71000, "North", ],
    ...
    [9, "長庚大學", "Chang Gung University", 19000, "North"],
...
plt.title('Government budget support for\n'
          ...
          'in North vs South in 2014', fontproperties="Arial")

# Tweak spacing to prevent clipping of ylabel
plt.tight_layout()

plt.savefig('Total_difference_2014.jpg')
plt.show()

university.to_excel("Heading_to_the_top_universities_in_the_world_2014.xlsx")
