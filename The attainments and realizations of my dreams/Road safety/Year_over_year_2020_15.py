...
cumulative_sum_series = pd.Series(data=summary, index=administrative_duty)
print(cumulative_sum_series)

figure, (axes1, axes2, axes3, axes4) = plt.subplots(4, figsize=(10, 10))
...
axes3 = cumulative_sum_series.transpose().plot.kde()

axes4 = sns.histplot(data=cumulative_sum_series.transpose(), kde=True)
