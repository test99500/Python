...
colors = plt.cm.BuPu.BuPu(np.linspace(0, 0.5, len(month_as_of_now)))
n_rows = len(deaths)
...
plt.xticks([])
plt.title("The Cumulative Number of Deaths in Road Accident in Taiwan by Region (2021/01-07)")
