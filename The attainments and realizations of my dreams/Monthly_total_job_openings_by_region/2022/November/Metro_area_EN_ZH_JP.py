...
position_vacancies = [1986+109298+61910+4247, 45574+32736+6243, 56198+3569+9591, 4316+6449+26284, 36088+4379]
...
plt.title("2022/11 台灣各生活圈職缺數\n the number of job openings in Taiwan by metro", fontsize=20)

# plt.ylabel("")
plt.xlabel("參考資料 Reference: https://web.archive.org/web/20221125151358/https://www.104.com.tw/jobs/main/category/?jobsource=category")
