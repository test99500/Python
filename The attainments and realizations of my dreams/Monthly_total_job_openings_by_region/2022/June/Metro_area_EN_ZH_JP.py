...
position_vacancies = [178202, 89216, 74059, 39413, 40549]
...
plt.title("2022/06 台灣各生活圈職缺數\n the number of job openings in Taiwan by metro", fontsize=20) # [1]

# plt.ylabel("")
plt.xlabel("參考資料 Reference: https://web.archive.org/web/20220624160139/https://www.104.com.tw/jb/category/?cat=2")
