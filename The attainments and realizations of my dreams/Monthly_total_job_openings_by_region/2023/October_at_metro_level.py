...
position_vacancies = [2253+118394+68186+4594, 45794+31743+6269, 59514+3718+10102, 4517+6926+26601, 38377+4517]
...
plt.title("2023/10 台灣各生活圈職缺數\n the number of job openings in Taiwan by metro", fontsize=20)

# plt.ylabel("")
plt.xlabel("參考資料 Reference https://web.archive.org/web/20231025065031/https://www.104.com.tw/jobs/main/category/?jobsource=category")
