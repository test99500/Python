...
position_vacancies = [2330+120454+70222+4816, 46557+32080+6382, 62522+3700+10519, 4735+7019+27428, 39162+4949]
...
plt.title("2023/08 台灣各生活圈職缺數\n the number of job openings in Taiwan by metro", fontsize=20)

# plt.ylabel("")
plt.xlabel("參考資料 Reference https://web.archive.org/web/20230825175852/https://www.104.com.tw/jobs/main/category/?jobsource=category")
