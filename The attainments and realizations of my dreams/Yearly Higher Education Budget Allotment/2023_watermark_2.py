...
public_research_centric_university = pd.DataFrame(data=[
    ...
    [21, "國立臺灣藝術大學", "National Taiwan University of Arts", 60668797, "North", ],
    ...
    [24, "國立臺北藝術大學", "The Taipei National University of the Arts", 57484349, "North", ],
    ...
    [27, "臺北市立大學", "University of Taipei", 55253550, "North", ],
    [28, "國立體育大學", "National Taiwan Sport University", 43469196, "North", ],
    [29, "國立聯合大學", "National United University", 48254839, "North", ],
    [30, "國立高雄師範大學", "National Kaohsiung Normal University", 50450179, "South", ],
    [31, "國立臺灣體育運動大學", "National Taiwan University of Sport", 33282255, "North", ],
