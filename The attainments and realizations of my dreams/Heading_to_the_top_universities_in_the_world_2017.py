...
plt.title('Government budget support for\n'
          ...
          'in North vs South in 2017', fontproperties="Arial")

# Tweak spacing to prevent clipping of ylabel
plt.tight_layout()

plt.savefig('Total_difference_2017.jpg')
plt.show()

university.to_excel("Heading_to_the_top_universities_in_the_world_2017.xlsx")
