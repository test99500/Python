...
public_research_centric_university = pd.DataFrame(data=[
    [1, "國立臺灣大學", "National Taiwan University", 232673, "North", ],
    [2, "國立成功大學", "National Cheng Kung University", 141284, "South", ],
    ...
    [7, "國立陽明交通大學（陽明校區）", "National Yang Ming Chiao Tung University (Taipei)", 34407, "North", ],
    [8, "國立政治大學", "National Chengchi University", 32164, "North", "Literally, 'National Politics University'"],
...
plt.title('Government budget support for\n'
          ...
          'in North vs South in 2021', fontproperties="MS Gothic") # [1]
