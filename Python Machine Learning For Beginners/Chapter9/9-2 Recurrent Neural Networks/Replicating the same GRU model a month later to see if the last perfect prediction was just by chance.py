...
from tensorflow.keras.layers import Input, Activation, Dense, Flatten, Dropout, LSTM, GRU
...
LSTM1 = GRU(units=100, activation='relu', return_sequences=True)(input_layer)
drop1 = Dropout(0.2)(LSTM1)
LSTM2 = GRU(units=100, activation='relu', return_sequences=True)(drop1)
drop2 = Dropout(0.2)(LSTM2)
LSTM3 = GRU(units=100, activation='relu', return_sequences=True)(drop2)
drop3 = Dropout(0.2)(LSTM3)
LSTM4 = GRU(units=100, activation='relu')(drop3)
...
plt.savefig('Stock price trajectory(Gated Recurrent Unit)August 2021.jpg')
