...
# Pass features to the constructor of linkage class.
dendros = linkage(y=features, method='single')

dendrogram(Z=dendros, orientation='top', labels=annots, distance_sort='descending', show_leaf_counts=True)
