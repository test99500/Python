...
input_layer = Input(2)
dense_layer = Dense(2, activation=sigmoid, use_bias=True, bias_initializer=Ones())(input_layer)
output_layer = Dense(1, activation=sigmoid, use_bias=True, bias_initializer=Ones())(dense_layer)
...
# After the generations complete, some plots are showed that summarize how the outputs/fitness
# values evolve over generations.
