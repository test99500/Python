...
circuit = nx.DiGraph()
# Layer 0
circuit.add_node(0, label="0", layer=0)
circuit.add_node(1, label="1", layer=0)
circuit.add_node(2, label="2", layer=0)
circuit.add_node(3, label="3", layer=0)
circuit.add_node(4, label="4", layer=0)

# Layer 1
circuit.add_node(5, label="5", layer=1)
circuit.add_node(6, label="6", layer=1)
circuit.add_node(7, label="7", layer=1)
circuit.add_node(8, label="8", layer=1)
...
# Layer 2
circuit.add_node(9, label="9", layer=2)
circuit.add_node(10, label="10", layer=2)
circuit.add_node(11, label="11", layer=2)
circuit.add_node(12, label="12", layer=2)
...
# Layer 3
circuit.add_node(13, label="13", layer=3)
circuit.add_node(14, label="14", layer=3)
