...
print("Confusion matrix: ", confusion_matrix(y_true=y_test, y_pred=y_prediction_Scaled))
print("Precision score: ", precision_score(y_true=y_test, y_pred=y_prediction_Scaled))
print("Recall: ", recall_score(y_true=y_test, y_pred=y_prediction_Scaled))
print("F1: ", f1_score(y_true=y_test, y_pred=y_prediction_Scaled))
