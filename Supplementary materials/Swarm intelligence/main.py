# Source: https://pyshine.com/Make-an-Interactive-Particle-Swarm-Optimization-algorithm/
# Welcome to PyShine
        ...
        while True:
            ...
            for j in range(0, num_particles):
                ...
                if swarm[j].error < global_best_error or global_best_error == -1:
                    ...
                    plt.title("PyShine Interactive PSO, Particles:{}, Error:{}".format(num_particles,
                                                                                       round(global_best_error, 1)))
